...
Project: unit test for "cards in hand"
...
int main(int argc, char** argv) {
    ...
    for(player = 0; player < numPlayers; player++)
    {
        ...
        {
            for (int card_num = 0; card_num < 27; card_num++)
            {
                G.hand[player][card] = card_num;
                my_assert(handCard(card, &G) == card_num);
            }
        }
        /* END RUN CARD CHECK*/
        /* BOUNDRY CHECKS*/
